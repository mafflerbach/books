...
var _117=$(ul).prev().children("span.fa-folder-o");
...
hit.next().addClass("fa-folder-open-o");
var ul=$(_11b).next();
if(ul.length){
if(opts.animate){
...
hit.next().removeClass("fa-folder-open-o");
var ul=$(_120).next();
if(opts.animate){
...
_137.removeClass("fa-file-text-o").addClass("fa-folder-o fa-folder-open-o");
...
node.find(".tree-icon").removeClass("fa-folder-o").addClass("fa-file-text-o");
...
cc.push("<li>");
    ...
    if (item.book == undefined) {
        content = 'data-chapter=\"'+item.chapter+'\"';
    } else {
        content = 'data-book=\"'+item.book+'\"';
    }
    if(item.section != undefined){
        content += 'data-section=\"'+item.section+'\" ';
    }

cc.push("<div id=\""+item.domId+"\" class=\"tree-node\" data-book=\""+item.book+"\" "+content+">");
for(var j=0;j<_19b;j++){
cc.push("<span class=\"tree-indent\"></span>");
}
if(item.state=="closed"){
cc.push("<span class=\"tree-hit tree-collapsed\"></span>");
cc.push("<span class=\"fa tree-icon fa-folder-o "+(item.iconCls?item.iconCls:"")+"\"></span>");
}else{
if(item.children&&item.children.length){
cc.push("<span class=\"tree-hit tree-expanded\"></span>");
cc.push("<span class=\"fa tree-icon fa-folder-o fa-folder-open-o "+(item.iconCls?item.iconCls:"")+"\"></span>");
}else{
cc.push("<span class=\"tree-indent\"></span>");
cc.push("<span class=\"fa tree-icon fa-file-text-o"+(item.iconCls?item.iconCls:"")+"\"></span>");
}
}
if(opts.checkbox){
...
if(_39f.iconCls){
$("<div class=\"fa menu-icon\"></div>").addClass(_39f.iconCls).appendTo(item);
}
if(_39f.disabled){
...
if(_3bd.iconCls){
$("<div class=\"fa menu-icon\"></div>").addClass(_3bd.iconCls).appendTo(item);
}
if(_3bd.id){
...
$("<div class=\"menu-icon fa\"></div>").addClass(_3ca.iconCls).appendTo(_3ca.target);
}
});
...
var _761=body.find("tr[node-id=\""+_75c+"\"] span.fa-folder-o");
...
if(_795.hasClass("fa-file-text-o")){
_795.removeClass("fa-file-text-o").addClass("fa-folder-o fa-folder-open-o");
...
tr.next("tr.treegrid-tr-tree").remove();
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
cell.find(".tree-icon").removeClass("fa-folder-o").addClass("fa-file-text-o");
...
if(row.state=="closed"){
cc.push("<span class=\"tree-hit tree-collapsed\"></span>");
cc.push("<span class=\"fa tree-icon fa-folder-o "+(row.iconCls?row.iconCls:"")+"\"></span>");
}else{
if(row.children&&row.children.length){
cc.push("<span class=\"tree-hit tree-expanded\"></span>");
cc.push("<span class=\"fa tree-icon fa-folder-o fa-folder-open-o "+(row.iconCls?row.iconCls:"")+"\"></span>");
}else{
cc.push("<span class=\"tree-indent\"></span>");
cc.push("<span class=\"fa tree-icon fa-file-text-o "+(row.iconCls?row.iconCls:"")+"\"></span>");
}
}
